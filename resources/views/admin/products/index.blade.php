...
@section('content')
                ...
                <div class="modal-body">
                    <form action="" method="post" id="form-edit">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="image" class="form-control" <span class="text-danger"
                                id="editimageError"></span>
                            <br>
    ...
    <section id="basic-datatable">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <table class="datatables-basic table" id="products">
                        <thead>
                            <tr>
                                <th width="5%">#</th>
                                <th>Name</th>
...
@section('page-script')
    ...
    <script src="{{ asset('js/scripts/tables/table-datatables-products.js') }}"></script>
